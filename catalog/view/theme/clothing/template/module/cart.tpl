<div id="cart">
  <div class="heading">
    <p><?php echo $heading_title; ?> <a><span id="cart-total"><?php echo $text_items; ?></span></a></p>
  </div>
  <div class="content">
    <?php if ($products || $vouchers) { ?>
    <div class="mini-cart-info mini_cart">
      <table>
    ...
    <div class="checkout"><a href="<?php echo $cart; ?>"><?php echo $text_cart; ?></a> <a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a>
    <div class="clear"></div>
    </div>
    <?php } else { ?>
